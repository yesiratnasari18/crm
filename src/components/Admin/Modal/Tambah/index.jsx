...
//     email: "",
//     password: "",
//     roles: "", // gunakan 'roles' untuk konsistensi dengan backend
//   });
...
//   const handleSubmit = (e) => {
//     e.preventDefault();
//     if (formData.nama && formData.email && formData.roles) {
//       onAdd(formData); // Sesuaikan data dengan backend
//       onClose(); 
...
//         <form onSubmit={handleSubmit}>
//           <div className="mb-4">
//             <label htmlFor="nama" className="block mb-1">Name:</label>
//             <input
//               type="text"
//               id="nama"
//               name="nama"
...
//           </div>
//           <div className="mb-4">
//             <label htmlFor="roles" className="block mb-1">Role:</label>
//             <select
//               id="roles"
//               name="roles"
//               className="border rounded w-full p-2"
